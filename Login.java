...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        JLabel lblusername = new JLabel("USERNAME");
         ...
         lblpassword.setFont(new Font("SAN SERIF", Font.BOLD, 15));
         p2.add(lblpassword);
         ...
         login.setBackground(new Color(25,26,27));
         ...
         signup.setBackground(new Color(28,29,30));
         ...
         password.setBackground(new Color(31,32,33));
